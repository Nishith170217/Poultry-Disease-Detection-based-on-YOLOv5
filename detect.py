...
def run(weights=ROOT / 'best.pt',  # model.pt path(s)
        ...
        exist_ok=True,  # existing project/name ok, do not increment PREVIOSLY FALSE
...
def parse_opt():
    ...
    parser.add_argument('--project', default='static', help='save results to project/name') #runs/detect
